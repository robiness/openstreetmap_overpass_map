...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(User user, UserProfile profile) authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(User user, UserProfile profile)? authenticated,
...
abstract class _$$AuthenticatedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({User user, UserProfile profile});
...
class _$AuthenticatedImpl implements _Authenticated {
  const _$AuthenticatedImpl({required this.user, required this.profile});
